...
Um projeto desenvolvido durante a Imersão Alura + Google Gemini, com o objetivo de criar uma aplicação simples, útil e eficiente utilizando HTML, CSS, JavaScript e um arquivo JSON como base de dados.
